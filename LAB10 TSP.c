...
// A function to calculate the total distance of the route
int calculate_distance(int dist[MAX_CITIES][MAX_CITIES], int path[], int n) {
    ...
    total_distance += dist[path[n - 1]][path[0]]; // Return to the starting city
    return total_distance;
}

// A recursive function to generate all permutations of cities and calculate the minimum distance
